	...
	CASE 
    	...
    	CASE 
    		WHEN SUB.UB_XCAIXA <> '' THEN 
    			SUM( ( XTA.XTA_ALTURA * XTA.XTA_LARG * XTA.XTA_COMPR ) * ( SUB.UB_XVOLUME -  FLOOR(SUB.UB_QUANT/SB5.B5_QE2) ) ) 
    		ELSE 
...
WHERE 
    SUB.UB_FILIAL  = '0404' 
    AND   SUB.UB_NUM     = '195534' 
    AND   SUB.D_E_L_E_T_ = '' 
GROUP BY SUB.UB_PRODUTO,SUB.UB_QUANT,SB5.B5_ALTURA,SB5.B5_LARG,SB5.B5_COMPR,SB5.B5_ALTURLC,SB5.B5_LARGLC,SB5.B5_COMPRLC,SB5.B5_QE2,SUB.UB_XCAIXA 