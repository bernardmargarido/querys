...
/****** Object:  View [dbo].[cpq_tabelapromocao]    Script Date: 03/07/2023 10:23:28 ******/
SET ANSI_NULLS ON
GO
...
FROM 
	...
	INNER JOIN [LABOR12-33]..DA0040 DA0 (NOLOCK) ON DA0.DA0_FILIAL = Z2.Z2_FILIAL AND DA0.DA0_CODTAB = Z2.Z2_TABELAS AND DA0.D_E_L_E_T_ = ''
