SELECT  
 ...
 UNPIVOT (PRECO FOR GRUPO IN(VISITANTES,COMUM,REVENDA_SP,FINAL_PJ,REV_N_NO,REV_S_SE,REV_VET_SP,FINAL_VET,REV_VET_N_NE_CO,REV_VET_S_SE,REV_VET_RJ,FINAL_PF,FINAL_PS)) UNPIVOTTABLE 
 WHERE PRECO > 0 
 ORDER BY PRODUTO 