		...
		FROM 
			...
			CROSS APPLY (  
						...
						WHERE  
							...
							C9.C9_BLEST <> '' AND  
							C9.C9_BLCRED = '  ' AND  
                            --( B2.B2_QATU - B2.B2_RESERVA ) >= IIF( C5.C5_TIPO = 'D', 0, C9.C9_QTDLIB ) AND   
							C9.C9_LOCAL IN ('01','06') AND  
							C9.D_E_L_E_T_ = ''  
			) LIBERADO  
		WHERE  
...
SELECT C5_LIBEROK,C5_XENVWMS,C5_NOTA,* FROM SC5040 WHERE C5_FILIAL = '0404' AND C5_NUM = '538237' AND D_E_L_E_T_ = ''
SELECT * FROM SC9040 WHERE C9_FILIAL = '0404' AND C9_PEDIDO = '538237' AND D_E_L_E_T_ = ''
SELECT * FROM ZZ4040 WHERE ZZ4_FILIAL = '0404' AND ZZ4_PEDIDO = '538237'