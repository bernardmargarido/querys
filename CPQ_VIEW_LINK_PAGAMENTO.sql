...
/****** Object:  View [dbo].[cpq_caixas]    Script Date: 07/02/2023 14:05:14 ******/
SET ANSI_NULLS ON
GO
...
FROM
	[LABOR-1233]..ZXF040 ZXF (NOLOCK)
	INNER JOIN [LABOR-1233]..SC5040 C5 (NOLOCK) ON C5.C5_FILIAL = ZXF.ZXF_FILIAL AND C5.C5_NUM = ZXF.ZXF_NUMPV AND C5.D_E_L_E_T_ = '' 
	INNER JOIN [LABOR-1233]..SA1040 A1 (NOLOCK) ON A1.A1_FILIAL = '' AND A1.A1_COD = C5.C5_CLIENTE AND A1.A1_LOJA = C5.C5_LOJACLI AND A1.D_E_L_E_T_ = ''
WHERE 
