...
FROM AY1010 AY1
INNER JOIN AY0010 AY0 ON AY0.AY0_CODIGO = AY1.AY1_SUBCAT AND AY0.AY0_ENVECO = '1' AND AY0.AY0_STATEC  = '2' AND AY0.D_E_L_E_T_ = ''
INNER JOIN SYP010 SYP ON SYP.YP_CHAVE = AY0.AY0_CODDES AND SYP.D_E_L_E_T_ = '' 
WHERE 
AY1.D_E_L_E_T_ = ' ' 
ORDER BY AY0_TIPO,AY1_CATPAI,AY1_CATFIL

-- Fabricante
SELECT AY2_CODIGO,CAST(CAST(AY2_DESECO AS BINARY) AS VARCHAR) DESCECO,AY2_STATUS, 
...
(SELECT BV_DESCRI FROM SBV010 SBV WHERE SBV.BV_TABELA = SB4.B4_COLUNA AND SBV.BV_CHAVE = SB1.B1_01CLGRD AND SBV.D_E_L_E_T_ = '') DESCCOL,
(SELECT BV_DESCRI FROM SBV010 SBV WHERE SBV.BV_TABELA = SB4.B4_LINHA AND SBV.BV_CHAVE = SB1.B1_01LNGRD AND SBV.D_E_L_E_T_ = '') DESCLIN, 
DA1.DA1_PRCVEN, DA1.R_E_C_N_O_ RECNODA1  
FROM 
SB4010 SB4 
INNER JOIN SB1010 SB1 ON  SB1.B1_FILIAL = '0101' AND SUBSTRING(B1_COD,1,LEN(SB4.B4_COD)) = SB4.B4_COD AND 
SB1.B1_STATECO = '2' AND SB1.B1_ENVECO = '1' AND SB1.B1_USAECO = '1' AND SB1.D_E_L_E_T_ = ' ' 
LEFT OUTER JOIN DA1010 DA1 ON DA1.DA1_FILIAL = '01' AND DA1.DA1_CODTAB = '001' AND ( DA1.DA1_CODPRO = SB1.B1_COD ) OR (DA1.DA1_REFGRD = SB4.B4_COD ) AND DA1.D_E_L_E_T_ = ' ' 
WHERE 
SB4.B4_FILIAL = '01' AND 
SB4.B4_ENVECO = '2' AND 
SB4.B4_01UTGRD IN('S','N') AND 
...
FROM 
SB4010 SB4 
INNER JOIN SB1010 SB1 ON SB1.B1_FILIAL = '0101' AND SUBSTRING(B1_COD,1,LEN(SB4.B4_COD)) = B4_COD AND SB1.B1_STATECO = '1' AND SB1.B1_ENVECO = '2' AND SB1.B1_USAECO = '1' AND SB1.D_E_L_E_T_ = ' ' 
WHERE 
SB4.B4_FILIAL = '01' AND 
SB4.B4_USAECO = '1' AND 
SB4.B4_ENVECO = '2' AND 
...
FROM 
SB2010 SB2 
INNER JOIN SB1010 SB1 ON SB1.B1_FILIAL = '0101' AND SB1.B1_COD = SB2.B2_COD AND SB1.B1_STATECO = '1' AND SB1.B1_ENVECO = '2' AND SB1.B1_USAECO = '1' AND SB1.D_E_L_E_T_ = '' 
INNER JOIN SB4010 SB4 ON SB4.B4_FILIAL = '01' AND SB4.B4_COD = SUBSTRING(SB1.B1_COD,1,LEN(SB4.B4_COD)) AND SB4.B4_USAECO = '1' AND SB4.D_E_L_E_T_ = ' ' 
WHERE 
SB2.B2_FILIAL = '0101' AND 
SB2.B2_LOCAL = '02' AND 
SB2.B2_MSEXP = '' AND 
SB2.D_E_L_E_T_ = '' 
ORDER BY B2_COD 
...
FROM 
AY3010 AY3 
INNER JOIN AY5010 AY5 ON AY5.AY5_FILIAL = '01' AND AY5_CODIGO = AY3.AY3_CODIGO AND AY5.D_E_L_E_T_ = '' 
INNER JOIN SB4010 SB4 ON SB4.B4_FILIAL = '01' AND SB4.B4_COD = AY5.AY5_CODPRO AND SB4.B4_USAECO = '1' AND SB4.B4_ENVECO = '2' AND SB4.B4_STATECO = '1' AND SB4.D_E_L_E_T_ = '' 
WHERE 
...
FROM 
AY5010 AY5 
INNER JOIN AY4010 AY4 ON AY4.AY4_FILIAL = '01' AND AY4.AY4_CODCAR = AY5.AY5_CODIGO AND AY4.AY4_SEQ = AY5.AY5_SEQ AND AY4.AY4_STATEC = '2' AND AY4.AY4_ENVECO = '1' AND AY4.D_E_L_E_T_ = '' 
...
LEFT OUTER JOIN SB1010 SB1 ON SB1.B1_FILIAL = '0101' AND SB1.B1_COD = DA1.DA1_CODPRO AND SB1.B1_ENVECO = '2' AND SB1.B1_STATECO = '1' AND SB1.B1_USAECO = '1' AND SB1.D_E_L_E_T_ = '' 
WHERE 
