...
/****** Object:  View [dbo].[cpq_previsao]    Script Date: 21/06/2023 18:52:25 ******/
SET ANSI_NULLS ON
GO
...
FROM 
 ( 
	...
	FROM 
		[LABOR12-33]..SW6040 W6 (NOLOCK) 
		INNER JOIN [LABOR12-33]..SW7040 W7 (NOLOCK) ON W7.W7_FILIAL = W6.W6_FILIAL AND W7.W7_HAWB = W6.W6_HAWB AND W7.D_E_L_E_T_ = '' 
		INNER JOIN [LABOR12-33]..SB1040 B1 (NOLOCK) ON B1.B1_FILIAL = '    ' AND B1.B1_COD = W7.W7_COD_I AND B1.D_E_L_E_T_ = ''
	WHERE 	
	...
	FROM 
		[LABOR12-33]..SW3040 W3 WITH(NOLOCK) 
		INNER JOIN [LABOR12-33]..SW5040 W5 WITH(NOLOCK) ON	W5.W5_FILIAL = W3.W3_FILIAL AND W5.W5_COD_I = W3.W3_COD_I AND 
												W5.W5_PO_NUM = W3.W3_PO_NUM AND W5.W5_POSICAO = W3.W3_POSICAO AND 
												W5.W5_SEQ = 0 AND W5.W5_SALDO_Q > 0 AND W5.D_E_L_E_T_ = '' 
		INNER JOIN [LABOR12-33]..SB1040 B1 (NOLOCK) ON B1.B1_FILIAL = '    ' AND B1.B1_COD = W3.W3_COD_I AND B1.D_E_L_E_T_ = ''
	WHERE 
	...
	FROM 
		[LABOR12-33]..SC7040 C7 
		INNER JOIN [LABOR12-33]..SB1040 B1 (NOLOCK) ON B1.B1_FILIAL = '    ' AND B1.B1_COD = C7.C7_PRODUTO AND B1.D_E_L_E_T_ = ''
	WHERE 
		NOT EXISTS( 
				SELECT 
					D1.D1_PEDIDO 
				FROM 
					[LABOR12-33]..SD1040 D1  
				WHERE 
