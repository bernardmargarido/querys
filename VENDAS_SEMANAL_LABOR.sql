WITH semana_atual AS (
    SELECT
        ...
        ( SUM(D2.D2_VALBRUT - D2.D2_ICMSRET - 
            ...
            D2.D2_DESCICM  - D2.D2_DIFAL - 
            D2.D2_ICMSCOM - D2.D2_VFCPDIF) -
        SUM(D2.D2_CUSTO1) ) / SUM(D2.D2_QUANT)  as margem_bruta
    FROM 
        SD2040 D2
    WHERE
        D2.D2_FILIAL = '0404' 
...
inventario AS (
    ...
    WHERE
        ...
        AND DATEPART(WEEK, data_estoque) = DATEPART(WEEK, GETDATE())
...
compras_semana AS (
    ...
    ( 
        ...
        WHERE 	
            ...
            AND W6.W6_NF_ENT = '' 
            AND W6.D_E_L_E_T_ = ''
            AND DATEPART(WEEK, CONVERT(DATE, W6.W6_PRVENTR)) = DATEPART(WEEK, GETDATE())
        ...
        WHERE 
            W3.W3_SEQ = 1 
            AND W3.D_E_L_E_T_ = ''
            AND DATEPART(WEEK, CONVERT(DATE, W3.W3_DT_ENTR)) = DATEPART(WEEK, GETDATE())
        ...
        WHERE 
            ...
            AND C7.D_E_L_E_T_ = ''
            AND DATEPART(WEEK, CONVERT(DATE, C7.C7_DATPRF)) = DATEPART(WEEK, GETDATE())
...
SELECT
    ...
    ISNULL(sa.total_vendido, 0)                                             as valor_vendas_anterior,
