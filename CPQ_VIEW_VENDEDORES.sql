...
/****** Object:  View [dbo].[cpq_vendedores]    Script Date: 11/07/2023 14:44:23 ******/
SET ANSI_NULLS ON
GO
...
SELECT
	...
	,CASE 
		WHEN SA3.A3_CODUSR <> '' THEN RTRIM(SA3.A3_CODUSR) 
		WHEN SA3.A3_CODUSR = '' AND SA3.A3_TIPO = 'E' THEN 'EX' + SUBSTRING(SA3.A3_COD,4,3) 
		ELSE 'IN' + SUBSTRING(SA3.A3_COD,4,3) 
	END AS codigoUsr
	...
	,CASE WHEN SA3.A3_XGRVEND <> '1' THEN '0' ELSE '1' END AS outros_inativo
FROM 
	[LABOR-PROD12]..SA3040 SA3 (NOLOCK)
	LEFT JOIN [LABOR-PROD12]..SA3040 SA3_SUP (NOLOCK)
	ON SA3_SUP.A3_COD = SA3.A3_SUPER 
	AND SA3_SUP.D_E_L_E_T_ = ''
	LEFT JOIN [LABOR-PROD12]..SA3040 SA3_GER (NOLOCK)
	ON SA3_GER.A3_COD = SA3.A3_GEREN 
	AND SA3_GER.D_E_L_E_T_ = ''
	LEFT JOIN [LABOR-PROD12]..SA3040 SA3_DIR (NOLOCK)
