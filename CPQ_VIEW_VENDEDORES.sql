...
/****** Object:  View [dbo].[cpq_vendedores]    Script Date: 07/06/2023 17:38:09 ******/
SET ANSI_NULLS ON
GO
...
FROM 
	[LABOR12-33]..SA3040 SA3 (NOLOCK)
	LEFT JOIN [LABOR12-33]..SA3040 SA3_SUP (NOLOCK)
	ON SA3_SUP.A3_COD = SA3.A3_SUPER 
	AND SA3_SUP.D_E_L_E_T_ = ''
	LEFT JOIN [LABOR12-33]..SA3040 SA3_GER (NOLOCK)
	ON SA3_GER.A3_COD = SA3.A3_GEREN 
	AND SA3_GER.D_E_L_E_T_ = ''
	LEFT JOIN [LABOR12-33]..SA3040 SA3_DIR (NOLOCK)
